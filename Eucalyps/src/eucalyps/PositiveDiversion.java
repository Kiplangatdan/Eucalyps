...
public class PositiveDiversion extends Activity {
	 public int QUIT = -1;
   ...
   protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
      ...
      if (storyIndex != StoryScreen.THE_END)
         run(storyIndex);
    	  ...
    	  finish();
    	  Intent i = new Intent(PositiveDiversion.this, Wordsearch.class);
    	  startActivity(i);
   ...
   public void run(final int storyIndex){
      ...
      if(story.get(storyIndex).type == StoryScreen.STORY_SCREEN)
         intent = new Intent(PositiveDiversion.this, StoriActivity.class);
      else if(story.get(storyIndex).type == StoryScreen.CHOICE_SCREEN)
         intent = new Intent(PositiveDiversion.this, ChoiceActivity.class);
      else if(story.get(storyIndex).type == StoryScreen.STATIC_SCREEN)
         intent = new Intent(PositiveDiversion.this, StaticActivity.class);
   ...
   private ArrayList<StoryScreen> parseXML() {
      ...
      try {
         ...
         xr.parse(new InputSource(getResources().openRawResource(R.raw.story_positive)));
