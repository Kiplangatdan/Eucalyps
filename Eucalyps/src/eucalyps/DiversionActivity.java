...
public class DiversionActivity extends MainActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final View v = getLayoutInflater()
				.inflate(R.layout.diversion_home, null);
 ...
 */
	...
	public void onClickFeature(View v) {
		...
		case R.id.home_btn_start:
			startActivity(new Intent(getApplicationContext(), PositiveDiversion.class));
			break;
		case R.id.home_btn_score:
			   startActivity(new Intent(getApplicationContext(), NegativeDiversion.class));
				break;
	      ...
	      if (id == QUIT) {
	         ...
	         dlgAlert.setPositiveButton(TYES,
	            ...
	            public void onClick(final DialogInterface dialog,
	               ...
	               setResult(-1);
	               finish();
	               Intent intent = new Intent(DiversionActivity.this, HomeActivity.class);
