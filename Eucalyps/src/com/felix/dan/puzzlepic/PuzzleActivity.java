...
import com.felix.dan.puzzlepic.PuzzleView.ShowNumbers;
...
public class PuzzleActivity extends Activity
{
	...
	protected static final String FILENAME_DIR = "name.felix.dan.eucalyps";
	...
	protected void findInternalImages(List<Uri> list)
	{
		...
		for(Field field: fields)
		{
			...
			{
				int id = getResources().getIdentifier(name, "drawable-ldpi/image_", getPackageName());
	...
	public void onFinish()
	{
		...
		showStats(stats);
		 finish();
		Intent intent = new Intent(PuzzleActivity.this, WelcomeScreen.class);
